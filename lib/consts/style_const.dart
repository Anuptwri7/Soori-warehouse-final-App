...
const kTextStyleBlackDropDown= TextStyle(fontSize: 16.0, color: Colors.black,fontWeight: FontWeight.bold);
...
const kHintTextStyle = TextStyle(color: Colors.black54, fontSize: 14.0);
