...
import 'package:soori_warehouse/ui/in/model/inModel.dart';
import 'package:soori_warehouse/ui/in/po_in_details.dart';
import 'package:soori_warehouse/ui/login/login_screen.dart';
import 'package:soori_warehouse/ui/transfer%20Order/transferSummary.dart';
...
class _TransferListPageState extends State<TransferListPage> {
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Center(
                            child: Text(
                              "${data['results'][index]['transfer_no'].toString()}",
                              style: TextStyle(fontWeight: FontWeight.bold),
                            )),
                      ),
                    ],
                      ...
                      Container(
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            //     :
                            // goToPage(context,
                            //     TransferSummaryPage(id: data['results'][index]['id']));
                            data['results'][index]['is_picked']==true?Fluttertoast.showToast(msg: "Already picked"):Navigator.push(context, MaterialPageRoute(builder: (context)=>TransferSummaryPage(id: data['results'][index]['id'])));
                          },
                          ...
                          style: ButtonStyle(
                            ...
                            MaterialStateProperty.all<Color>(
                                data['results'][index]['is_picked']==true
  ...
  Future transferMaster() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String finalUrl = prefs.getString("subDomain").toString();
    final response = await http.get(
        Uri.parse("https://$finalUrl${StringConst.transferMaster}transfer-master?limit=0&ordering=-transfer_no"),
        headers: {
    ...
    //     'https://$finalUrl${StringConst.transferMaster}transfer-master?limit=0&ordering=-transfer_no')
    //     .getOrdersWithToken();
