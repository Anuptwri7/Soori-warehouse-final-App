...
import 'package:soori_warehouse/Chalan/Chalan%20Return/chalanReturnAdd.dart';
import 'package:soori_warehouse/Chalan/Chalan%20Return/chalanView.dart';

import 'Services/chalanReturnAPI.dart';

class ChalanReturnPage extends StatefulWidget {
  const ChalanReturnPage({Key? key}) : super(key: key);

  @override
  State<ChalanReturnPage> createState() =>
      _ChalanReturnPageState();
}

class _ChalanReturnPageState extends State<ChalanReturnPage> {
  // String get $i => null;
  ...
  Future searchHandling() async {
    ...
    if (_searchItem == "") {
      return await chalanServices.fetchChalanReturn('');
    } else {
      return await chalanServices.fetchChalanReturn(_searchItem);
    }
  }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ElevatedButton(
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>AddChalan()));
                          },
                          child: Text("Add +"),
                        ),
                        // TextFormField(
                          ...
                          builder:
                            ...
                            if (snapshot.hasData) {
                              try {
                                ...
                                ChalanReturn chalanReturn =
                                ChalanReturn .fromJson(snapshotData);
